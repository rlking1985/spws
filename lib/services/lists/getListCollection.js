...
var responseError_1 = require("../../classes/responseError");
 ...
 */
var getListCollection = function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.parse, parse = _c === void 0 ? __1.defaults.parse : _c, _d = _b.webURL, webURL = _d === void 0 ? __1.defaults.webURL : _d;
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var req, res, responseXML, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (parse) {
                        ...
                        res.data = __spreadArray([], __read(responseXML.querySelectorAll("List")), false).map(function (list) {
                            return __spreadArray([], __read(list.attributes), false).reduce(function (object, _a) {
...
exports.default = getListCollection;
//# sourceMappingURL=getListCollection.js.map