...
var getList = function (_a) {
    var listName = _a.listName, _b = _a.parse, parse = _b === void 0 ? __1.defaults.parse : _b, _c = _a.webURL, webURL = _c === void 0 ? __1.defaults.webURL : _c;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (parse) {
                        ...
                        res.data = __spreadArray([], __read(responseXML.querySelector("List").attributes), false).reduce(function (object, _a) {
